class WeaponFactory {
    ...
    static createPistol(entityID, trackID) {
        ...
        componentsDict[ProjectileWeaponComponent] = new ProjectileWeaponComponent(entityID, 0.05, 125, 0, 1, 1, 3000, 0, 0, ProjectileWeaponComponent.BULLET_MATERIAL);
    ...
    static createMachineGun(entityID, trackID) {
        ...
        componentsDict[ProjectileWeaponComponent] = new ProjectileWeaponComponent(entityID, 0.1, 125, 0, 1, 1, 2500, 0, 0, ProjectileWeaponComponent.BULLET_MATERIAL);
        componentsDict[BulletWeaponComponent] = new BulletWeaponComponent(entityID, 6);
        return componentsDict;
    ...
    static createShotgun(entityID, trackID) {
        ...
        const renComp = new RenderComponent(entityID, 'green', 'green', GameScene.WEAPON_LAYER);
        const shapeComp = new ShapeComponent(entityID, p2.Shape.BOX, {width: 25, height: 8}, [0, 0], ShapeComponent.CENTER_LEFT, 0);
        const transComp = new TransformComponent(entityID, [0, 0], 0);
        const trackComp = new TrackingComponent(entityID, trackID, ShapeComponent.CENTER, [0, 3], 1);
        const fatalComp = new FatalDependencyComponent(entityID, trackID);
        ...
        componentsDict[TrackingComponent] = trackComp;
        componentsDict[FatalDependencyComponent] = fatalComp;
        componentsDict[WeaponComponent] = new WeaponComponent(entityID, 15, 600, true, 1);
        componentsDict[ProjectileWeaponComponent] = new ProjectileWeaponComponent(entityID, 0.5, 125, 100, 1, 1, 200, 0, 0.3, ProjectileWeaponComponent.BULLET_MATERIAL);
        componentsDict[BulletWeaponComponent] = new BulletWeaponComponent(entityID, 5);
        return componentsDict;
    ...
    static createMinigun(entityID, trackID) {
        ...
        componentsDict[ProjectileWeaponComponent] = new ProjectileWeaponComponent(entityID, 0.7, 150, 0, 1, 1, 1750, 0, 0, ProjectileWeaponComponent.BULLET_MATERIAL);
        componentsDict[BulletWeaponComponent] = new BulletWeaponComponent(entityID, 5);
        return componentsDict;
